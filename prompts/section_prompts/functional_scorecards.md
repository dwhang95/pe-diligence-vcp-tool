...
**100-Day Priority (Y/N):** Y if material enough to address in the first 100 days post-close; N otherwise.
...
**Future CIM Gap?:** Y if this dimension is likely to be missing or misrepresented in a future CIM/management presentation and must be independently verified; N if likely surfaced organically.
